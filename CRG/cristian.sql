...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2023 a las 22:19:47
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `crear` (IN `nam` VARCHAR(15), IN `eda` INT, IN `profe` VARCHAR(15))   BEGIN 
INSERT INTO usuarios (nombre,edad,profecion) VALUES (nam,eda,profe);
END$$
